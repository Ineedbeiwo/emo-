    ...
    QObject(parent)
{
    ...
    if (QFile::exists(configFile)) {
        ...
        m_token  = settingFile.value("OpenAPI/token").toString();
        ...
        m_iFastMode=   settingFile.value("OpenAPI/FastMode").toInt();
        m_iHubMode =    settingFile.value("OpenAPI/HubMode").toInt();
    }
    else {
        ...
        m_token = "";
        settingFile.setValue("OpenAPI/token", m_token);
        ...
        m_iFastMode = 0;
        settingFile.setValue("OpenAPI/FastMode", m_iFastMode);

        m_iHubMode = 0;
        settingFile.setValue("OpenAPI/HubMode", m_iHubMode);
    }
...
int  LocalSetting::getCloudFastPlayMode()
{
    return m_iFastMode;
}
int  LocalSetting::getHubMode()
{
     return m_iHubMode;
}
