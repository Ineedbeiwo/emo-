...
public:
    ...
    int startRealPlayExtend(const QString& session, HWND hPlayWnd,const QString& devSerial, const QString& SuperSerial, const int iChannelNo, const QString& SafeKey);
    ...
    int startPlayBackExtend(const QString& session, HWND hPlayWnd, const QString& devSerial,const QString& superSerial,  const int iChannelNo, const QString& safekey, const QString& startTime, const QString& stopTime);
    
    
    int playBackResume(const QString& session);
    int playBackPause(const QString& session); 
    int setPlayBackScale(const QString& session,int iScale,const char* szOsdTime,int mode);
