...
public:
    ...
    QLabel *SuperSerial_label;
    QLineEdit *SuperSerial_lineEdit;
    ...
    void setupUi(QDialog *SingleDeviceLogin)
    {
        ...
        SingleDeviceLogin->resize(450, 258);
        ...
        SuperSerial_label = new QLabel(groupBox);
        SuperSerial_label->setObjectName(QString::fromUtf8("SuperSerial_label"));
        SuperSerial_label->setMaximumSize(QSize(80, 50));

        horizontalLayout_5->addWidget(SuperSerial_label);

        SuperSerial_lineEdit = new QLineEdit(groupBox);
        SuperSerial_lineEdit->setObjectName(QString::fromUtf8("SuperSerial_lineEdit"));
        sizePolicy1.setHeightForWidth(SuperSerial_lineEdit->sizePolicy().hasHeightForWidth());
        SuperSerial_lineEdit->setSizePolicy(sizePolicy1);
        SuperSerial_lineEdit->setMinimumSize(QSize(300, 25));
        SuperSerial_lineEdit->setMaximumSize(QSize(300, 25));
        horizontalLayout_5->addWidget(SuperSerial_lineEdit);
        ...
        horizontalLayout_6->setObjectName(QString::fromUtf8("horizontalLayout_5"));
    ...
    void retranslateUi(QDialog *SingleDeviceLogin)
    {
        ...
        SuperSerial_label->setText(QApplication::translate("SingleDeviceLogin", "SuperSerial:", 0, QApplication::UnicodeUTF8));
...
public:
    ...
    void getSuperSerialFromLogin(QString& superSerial);
    void clearParam();
