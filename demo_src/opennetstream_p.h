...
typedef OPENSDK_RESULT (__stdcall *EZSDK_StartRealPlayExtend)(const char* szSessionId, HWND hPlayWnd, const char* szDevSerial, const char* szSuperSerial, const int iChannelNo, const char* szSafeKey);
...
typedef OPENSDK_RESULT (__stdcall *EZSDK_StartPlayBackExtend)(const char* szSessionId, HWND hPlayWnd, const char* szDevSerial, const char* szSuperSerial, const int iChannelNo, const char* szSafeKey, const char* szStartTime, const char* szStopTime);
 ...
 *  该接口只能在OpenSDK_StartPlayBack() 调用之后才能调用
 */
typedef OPENSDK_RESULT (__stdcall *EZSDK_SetPlayBackScale)(const char* szSessionId,int iScale, const char* szOsdTime,int mode);
...
struct tagNETSTREAMAPI
{
    ...
    EZSDK_StartRealPlayExtend     pOpenSDK_startRealPlayExtend;
    EZSDK_StopRealPlayEx          pOpenSDK_stopRealPlay;
    EZSDK_StartPlayBackEx         pOpenSDK_startPlayBack;
    EZSDK_StartPlayBackExtend     pOpenSDK_startPlayBackExtend;
