...
public:
	...
	{
		switchPlat_Dialog->setWindowTitle(QApplication::translate("switchPlat_Dialog", "Dialog", 0, QApplication::UnicodeUTF8));
		groupBox->setTitle(QApplication::translate("switchPlat_Dialog", "SwitchPlatform", 0, QApplication::UnicodeUTF8));
		OKButton->setText(QApplication::translate("switchPlat_Dialog", "OK", 0, QApplication::UnicodeUTF8));
		AuthAddr->setText(QApplication::translate("switchPlat_Dialog", "AuthAddress", 0, QApplication::UnicodeUTF8));
		PlatAddr->setText(QApplication::translate("switchPlat_Dialog", "PlatformAddress", 0, QApplication::UnicodeUTF8));
		AppID->setText(QApplication::translate("switchPlat_Dialog", "AppID", 0, QApplication::UnicodeUTF8));
	} // retranslateUi
